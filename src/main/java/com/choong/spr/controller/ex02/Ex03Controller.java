...
public class Ex03Controller {
	...
	public String method05() {
		System.out.println("ex03/sub05 get type");
		return null;
	}
	
	@PostMapping("sub06")
	public String method06() {
		System.out.println("ex03/sub06 post type");
		return null;
	}
//	@RequestMapping(method = RequestMethod.DELETE, value = "sub07")
	@DeleteMapping("sub07")
	public String method07() {
		System.out.println("ex03/sub07 delete type");
	...
	public String method08() {
		System.out.println("ex03/sub08 put type");
	...
	public ResponseEntity<String> method18() {
		...
		if(success) {
			return ResponseEntity.ok().body("data success");
		} else {
